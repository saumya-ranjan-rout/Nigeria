...
export function AddEmployeeTimesheetNbraid() {
...
const handleSubmit = (event) => {
  ...
  $.ajax({
    url: 'http://192.168.29.243:4000/getaddemployeetimesheetfilterdatanbraidota',
    method: 'POST',
    data: jsonData,
    processData: false,
            ...
            <form onSubmit={handleSubmit} method='POST'>
             ...
             <div className="col-sm-2">
                ...
                <select
                  ...
                  className="form-control"
                  name="site"
                  value={formData.site} onChange={handleInputChange} required>
                ...
                <div className="col-sm-4">
                  ...
                  >
                    ...
                    {opOptions.map((opOption) => (
                      <option key={opOption.opid} value={opOption.opid}>
                        {opOption.name}
                      </option>
                    ))}
...
export default AddEmployeeTimesheetNbraid;
