...
export function DashboardAttritionComponent() {
  ...
  const fetchtotalotabraid = async () => {
          try {
              const response = await axios.get('http://192.168.29.243:4000/fetchtotalotabraid');
          ...
          const fetchpresentotabraid = async () => {
            try {
                const response = await axios.get('http://192.168.29.243:4000/fetchpresentotabraid');
                const data = response.data[0];
                //alert('Ikeja Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
            ...
            const fetchabsentotabraid = async () => {
              try {
                  const response = await axios.get('http://192.168.29.243:4000/fetchabsentotabraid');
                  const data = response.data[0];
                  //alert('Ikeja Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
         ...
         const fetchtotalotanbraid = async () => {
          try {
              const response = await axios.get('http://192.168.29.243:4000/fetchtotalotanbraid');
              const data = response.data[0];
              //alert('Ikeja Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
          ...
          const fetchpresentotanbraid = async () => {
            try {
                const response = await axios.get('http://192.168.29.243:4000/fetchpresentotanbraid');
                const data = response.data[0];
                //alert('Ikeja Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
            ...
            const fetchabsentotanbraid = async () => {
              try {
                  const response = await axios.get('http://192.168.29.243:4000/fetchabsentotanbraid');
                  const data = response.data[0];
                  //alert('Ikeja Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
   ...
   const fetchtotalikejabraid = async () => {
          try {
              const response = await axios.get('http://192.168.29.243:4000/fetchtotalikejabraid');
              const data = response.data[0];
              //alert('Ikeja Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
          ...
          const fetchpresentikejabraid = async () => {
            try {
                const response = await axios.get('http://192.168.29.243:4000/fetchpresentikejabraid');
                const data = response.data[0];
                //alert('Ikeja Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
            ...
            const fetchabsentikejabraid = async () => {
              try {
                  const response = await axios.get('http://192.168.29.243:4000/fetchabsentikejabraid');
                  const data = response.data[0];
                  //alert('Ikeja Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
         ...
         const fetchtotalikejanbraid = async () => {
          try {
              const response = await axios.get('http://192.168.29.243:4000/fetchtotalikejanbraid');
              const data = response.data[0];
              //alert('Ikeja Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
          ...
          const fetchpresentikejanbraid = async () => {
            try {
                const response = await axios.get('http://192.168.29.243:4000/fetchpresentikejanbraid');
                const data = response.data[0];
                //alert('Ikeja Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
            ...
            const fetchabsentikejanbraid = async () => {
              try {
                  const response = await axios.get('http://192.168.29.243:4000/fetchabsentikejanbraid');
                  const data = response.data[0];
                  //alert('Ikeja Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
        ...
        try {
            ...
            console.error('Error fetching dates:', error);
                                ...
                                const ota_braid_total_day = async () => {
                                  try {
                                      const response = await axios.get('http://192.168.29.243:4000/ota_braid_total_day');
                                      const data = response.data;
                                  ...
                                  const ota_braid_total_present_day = async () => {
                                    try {
                                        const response = await axios.get('http://192.168.29.243:4000/ota_braid_total_present_day');
                                        const data = response.data;
                                    ...
                                    const ota_braid_total_absent_day = async () => {
                                      try {
                                          const response = await axios.get('http://192.168.29.243:4000/ota_braid_total_absent_day');
                                          const data = response.data;
                                  ...
                                  const ota_braid_total_night = async () => {
                                    try {
                                        const response = await axios.get('http://192.168.29.243:4000/ota_braid_total_night');
                                        const data = response.data;
                                  ...
                                  const ota_braid_total_present_night = async () => {
                                    try {
                                        const response = await axios.get('http://192.168.29.243:4000/ota_braid_total_present_night');
                                        const data = response.data;
                                    ...
                                    const ota_braid_total_absent_night = async () => {
                                      try {
                                          const response = await axios.get('http://192.168.29.243:4000/ota_braid_total_absent_night');
                                          const data = response.data;
                                ...
                                const ota_nbraid_total_day = async () => {
                                  try {
                                      const response = await axios.get('http://192.168.29.243:4000/ota_nbraid_total_day');
                                      const data = response.data;
                                  ...
                                  const ota_nbraid_total_present_day = async () => {
                                    try {
                                        const response = await axios.get('http://192.168.29.243:4000/ota_nbraid_total_present_day');
                                        const data = response.data;
                                    ...
                                    const ota_nbraid_total_absent_day = async () => {
                                      try {
                                          const response = await axios.get('http://192.168.29.243:4000/ota_nbraid_total_absent_day');
                                          const data = response.data;
                                  ...
                                  const ota_nbraid_total_night = async () => {
                                    try {
                                        const response = await axios.get('http://192.168.29.243:4000/ota_nbraid_total_night');
                                        const data = response.data;
                                  ...
                                  const ota_nbraid_total_present_night = async () => {
                                    try {
                                        const response = await axios.get('http://192.168.29.243:4000/ota_nbraid_total_present_night');
                                        const data = response.data;
                                    ...
                                    const ota_nbraid_total_absent_night = async () => {
                                      try {
                                          const response = await axios.get('http://192.168.29.243:4000/ota_nbraid_total_absent_night');
                                          const data = response.data;
                              ...
                              //table ikeja data fetch
                               ...
                               //fetch ikeja braid day
                                ...
                                const ikeja_braid_total_day = async () => {
                                  try {
                                      const response = await axios.get('http://192.168.29.243:4000/ikeja_braid_total_day');
                                      const data = response.data;
                                  ...
                                  const ikeja_braid_total_present_day = async () => {
                                    try {
                                        const response = await axios.get('http://192.168.29.243:4000/ikeja_braid_total_present_day');
                                        const data = response.data;
                                    ...
                                    const ikeja_braid_total_absent_day = async () => {
                                      try {
                                          const response = await axios.get('http://192.168.29.243:4000/ikeja_braid_total_absent_day');
                                          const data = response.data;
                                  ...
                                  const ikeja_braid_total_night = async () => {
                                    try {
                                        const response = await axios.get('http://192.168.29.243:4000/ikeja_braid_total_night');
                                        const data = response.data;
                                  ...
                                  const ikeja_braid_total_present_night = async () => {
                                    try {
                                        const response = await axios.get('http://192.168.29.243:4000/ikeja_braid_total_present_night');
                                        const data = response.data;
                                    ...
                                    const ikeja_braid_total_absent_night = async () => {
                                      try {
                                          const response = await axios.get('http://192.168.29.243:4000/ikeja_braid_total_absent_night');
                                          const data = response.data;
                                ...
                                const ikeja_nbraid_total_day = async () => {
                                  try {
                                      const response = await axios.get('http://192.168.29.243:4000/ikeja_nbraid_total_day');
                                      const data = response.data;
                                  ...
                                  const ikeja_nbraid_total_present_day = async () => {
                                    try {
                                        const response = await axios.get('http://192.168.29.243:4000/ikeja_nbraid_total_present_day');
                                        const data = response.data;
                                    ...
                                    const ikeja_nbraid_total_absent_day = async () => {
                                      try {
                                          const response = await axios.get('http://192.168.29.243:4000/ikeja_nbraid_total_absent_day');
                                          const data = response.data;
                                  ...
                                  const ikeja_nbraid_total_night = async () => {
                                    try {
                                        const response = await axios.get('http://192.168.29.243:4000/ikeja_nbraid_total_night');
                                        const data = response.data;
                                  ...
                                  const ikeja_nbraid_total_present_night = async () => {
                                    try {
                                        const response = await axios.get('http://192.168.29.243:4000/ikeja_nbraid_total_present_night');
                                        const data = response.data;
                                    ...
                                    const ikeja_nbraid_total_absent_night = async () => {
                                      try {
                                          const response = await axios.get('http://192.168.29.243:4000/ikeja_nbraid_total_absent_night');
                                          const data = response.data;
...
const braid_daywise_active_employees_staff = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/braid_daywise_active_employees_staff');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
 ...
 const braid_daywise_active_employees_staff_present = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/braid_daywise_active_employees_staff_present');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
  ...
  const braid_daywise_active_employees_staff_absent = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/braid_daywise_active_employees_staff_absent');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
  ...
  const braid_daywise_active_employees_contract = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/braid_daywise_active_employees_contract');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
 ...
 const braid_daywise_active_employees_contract_present = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/braid_daywise_active_employees_contract_present');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
  ...
  const braid_daywise_active_employees_contract_absent = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/braid_daywise_active_employees_contract_absent');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
  ...
  const braid_daywise_active_employees_casual = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/braid_daywise_active_employees_casual');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
 ...
 const braid_daywise_active_employees_casual_present = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/braid_daywise_active_employees_casual_present');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
  ...
  const braid_daywise_active_employees_casual_absent = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/braid_daywise_active_employees_casual_absent');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
  ...
  const braid_daywise_active_employees_outsourcing = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/braid_daywise_active_employees_outsourcing');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
 ...
 const braid_daywise_active_employees_outsourcing_present = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/braid_daywise_active_employees_outsourcing_present');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
  ...
  const braid_daywise_active_employees_outsourcing_absent = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/braid_daywise_active_employees_outsourcing_absent');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
...
const nbraid_daywise_active_employees_staff = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/nbraid_daywise_active_employees_staff');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
 ...
 const nbraid_daywise_active_employees_staff_present = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/nbraid_daywise_active_employees_staff_present');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
  ...
  const nbraid_daywise_active_employees_staff_absent = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/nbraid_daywise_active_employees_staff_absent');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
  ...
  const nbraid_daywise_active_employees_contract = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/nbraid_daywise_active_employees_contract');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
 ...
 const nbraid_daywise_active_employees_contract_present = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/nbraid_daywise_active_employees_contract_present');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
  ...
  const nbraid_daywise_active_employees_contract_absent = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/nbraid_daywise_active_employees_contract_absent');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
  ...
  const nbraid_daywise_active_employees_casual = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/nbraid_daywise_active_employees_casual');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
 ...
 const nbraid_daywise_active_employees_casual_present = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/nbraid_daywise_active_employees_casual_present');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
  ...
  const nbraid_daywise_active_employees_casual_absent = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/nbraid_daywise_active_employees_casual_absent');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
  ...
  const nbraid_daywise_active_employees_outsourcing = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/nbraid_daywise_active_employees_outsourcing');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
 ...
 const nbraid_daywise_active_employees_outsourcing_present = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/nbraid_daywise_active_employees_outsourcing_present');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
  ...
  const nbraid_daywise_active_employees_outsourcing_absent = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/nbraid_daywise_active_employees_outsourcing_absent');
          const data = response.data;
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
   ...
   const fetchindirectikeja = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/fetchindirectikeja');
          const data = response.data[0];
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
      ...
      const fetchindirectota = async () => {
        try {
            const response = await axios.get('http://192.168.29.243:4000/fetchindirectota');
            const data = response.data[0];
            //alert('Ikeja Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
  ...
  const fetchattritionbraid = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/fetchattritionbraid');
          const data = response.data[0];
          //alert('Ota Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
      ...
      const fetchattritionNbraid = async () => {
        try {
            const response = await axios.get('http://192.168.29.243:4000/fetchattritionNbraid');
            const data = response.data[0];
            //alert('Ikeja Date Data:' + JSON.stringify(data, null, 2)); // Log the fetched data
  ...
  return (
    <div className="container">
      ...
      <section id="content">
       ...
       <div class=" p-2 bg-blue-subtle text-white rounded">
...
<div class="mt-4 p-2 bg-green-subtle text-white rounded">
 ...
 <div className="mt-4 mb-4 row">
      <div class="col-4">
       <table width="100%" border="1" cellspacing="0" className="border-class">
          <tr>
        <td colspan="2" style={{ textAlign: 'center' }}><strong>ATTRITION - MTD</strong> ({mon})
        </td>
    </tr>
...
export default DashboardAttritionComponent;
