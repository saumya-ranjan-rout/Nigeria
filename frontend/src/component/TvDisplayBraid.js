...
export function TvDisplayBraid() {
  ...
  const [wmslide, setWmSlide] = useState([]);
  const [wmmtdslide, setWmMtdSlide] = useState([]);
...
*/
  ...
  useEffect(() => {
    document.title = 'PRODUCTIVITY DASHBOARD FOR OTA';
      ...
      fetchmtdpppslide();
      fetchWastageManagementslide();
      fetchWastageManagementmtdslide();
              ...
              <div className="cardslide1-header custom-card-header1">
                ...
                <div className="cardslide1-body">
                  ...
                  <div class="col-md-6">
                   <div class="row" >
                        <div class="col-md-4" >
                          <b style={{ color: 'green' }}>ITEM DESCRIPTION</b>
                        </div>
                        <div class="col-md-4" >
                          <b style={{ color: 'green' }}>COLOR</b>
                        </div>
                        <div class="col-md-4"  >
                          <b style={{ color: 'green' }}>QTY</b>
                        </div>
                ...
                <div className="cardslide5-body">
                  <div class="row" >
                                 <div class="col-md-4" >
                                  ...
                                  <div class="col-md-4" >
                                   <b style={{ color: 'green' }}>BOM Wastage</b>
                                  </div>
                                  <div class="col-md-4"  >
                                   <b style={{ color: 'green' }}>Captured Waste</b>
                                  </div>
                      </div>
                        ...
                        {wmslide.length > 0 ? (
                            // Render the data when it's available
                            wmslide.map((row1, index) => (
                              
                                    <div className="row" key={index}>
                                        <div className="col-md-4" style={{ color: '#000' ,fontSize:'12px' }}>
                                            {row1.itemDescription}
                                        </div>
                                        <div className="col-md-4" style={{ color: '#000' ,fontSize:'12px' }}>
                                          {row1.bom}
...
const fetchtotalemployees = async () => {
    try {
      const response = await axios.get('http://192.168.29.243:4000/fetchtotalemployees1');
  ...
  const fetchtotalpresentemployees = async () => {
    try {
      const response = await axios.get('http://192.168.29.243:4000/fetchtotalpresentemployees1');
      const data = response.data;
  ...
  const fetchtotalabsentemployees = async () => {
    try {
      const response = await axios.get('http://192.168.29.243:4000/fetchtotalabsentemployees1');
      const data = response.data;
  ...
  const fetchtotalactiveemployees = async () => {
    try {
      const response = await axios.get('http://192.168.29.243:4000/fetchtotalactiveemployees1');
      const data = response.data;
  ...
  const fetchmtdavgoutput = async () => {
    try {
        const response = await axios.get('http://192.168.29.243:4000/fetchmtdavgoutput1');
        const data = response.data;
    ...
    const fetchtotalfgoutput = async () => {
      try {
          const response = await axios.get('http://192.168.29.243:4000/fetchtotalfgoutput1');
          const data = response.data;
      ...
      {/*const fetchshopfloorppp = async () => {
        ...
        const fetchmtdppp = async () => {
          try {
              const response = await axios.get('http://192.168.29.243:4000/fetchmtdppp1');
              const data = response.data;
              setMtdPpp(data.resk);
            } catch (error) {
              console.error('Error fetching total workers:', error);
  ...
  const fetchfgoutputslide = async () => {
    try {
      const response = await axios.get('http://192.168.29.243:4000/fetchfgoutputslide1');
   ...
   const fetchplanvstargetslide = async () => {
    try {
      const response = await axios.get('http://192.168.29.243:4000/fetchplanvstargetslide1');
      const data = response.data;
  ...
  const fetchitemwisepppslide = async () => {
    try {
      const response = await axios.get('http://192.168.29.243:4000/fetchitemwisepppslide1');
      const data = response.data;
      console.log('Data from the API:', data);
      setIWPPPSlide(data);
...
const fetchmtdpppslide = async () => {
    try {
      const response = await axios.get('http://192.168.29.243:4000/fetchmtdpppslide1');
      const data = response.data;
      console.log('Data from the API:', data);
      setMTDPPPSlide(data);
...
const fetchWastageManagementslide = async () => {
    try {
      const response = await axios.get('http://192.168.29.243:4000/fetchWastageManagementslide1');
      const data = response.data;
      console.log('Data from the API:', data);
      setWmSlide(data);
...
const fetchWastageManagementmtdslide = async () => {
    try {
      const response = await axios.get('http://192.168.29.243:4000/fetchWastageManagementmtdslide1');
      const data = response.data;
      console.log('Data from the API:', data);
      setWmMtdSlide(data);
                ...
                <div className="cardtv" id="breathing-button">
                  <div className="cardtv-body">
                   <div className="row">
                      ...
                      <div className="col-md-3">
                       <h5 className="text-dark"><b>{(mtdFgOutput / mtdPpp).toFixed(2)}</b></h5>
                      </div>
                    </div>
                  </div>
                </div>
