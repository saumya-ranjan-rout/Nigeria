...
export function AddNewWasteComponent() {
  ...
  const handleSubmit = (event) => {
    ...
    $.ajax({
      url: 'http://192.168.29.243:4000/addwaste',
      method: 'POST',
      data: formData,
      success: function (response) {
        ...
        //history.push('/master/waste-master');
              ...
              <label className="col-sm-2 col-form-label"
                    ...
                    <div className="col-sm-6">
                        <input type="text" placeholder=" Name"
                               className="form-control margin-bottom  " name="waste_name" id="waste_name" value={formData.waste_name}  onChange={handleInputChange} required/>
                    </div>
                </div>
...
export default AddNewWasteComponent;
