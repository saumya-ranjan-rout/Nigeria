...
export function AddNewMachineComponent() {
...
const postData = {
    ...
    $.ajax({
      url: 'http://192.168.29.243:4000/addmachine',
      method: 'POST',
      data: postData,
      success: function (response) {
        ...
        //history.push('/master/machine-master');
...
export default AddNewMachineComponent;
