...
export function AddNewColorComponent() {
  ...
  const handleSubmit = (event) => {
    ...
    $.ajax({
      url: 'http://192.168.29.243:4000/addcolor',
      method: 'POST',
      data: formData,
              ...
              <label className="col-sm-2 col-form-label"
                    ...
                    <div className="col-sm-6">
                        <input type="text" placeholder=" Name"
                               className="form-control margin-bottom  required" name="color_name" id="color_name" value={formData.color_name}  onChange={handleInputChange} required />
                    </div>
                </div>
...
export default AddNewColorComponent;
