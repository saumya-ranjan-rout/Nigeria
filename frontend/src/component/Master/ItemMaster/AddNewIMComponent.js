...
export function AddNewIMComponent() {
...
const [serverMessage, setServerMessage] = useState('');
  ...
  $.ajax({
    url: 'http://192.168.29.243:4000/getsectiontarget', // Replace 'your-api-endpoint' with the actual endpoint URL
    method: 'GET',
   ...
   $.ajax({
    url: 'http://192.168.29.243:4000/getcategories', // Replace with the actual API endpoint for fetching categories
    method: 'GET',
    success: function (response) {
  ...
  const handleCategoryChange = (e) => {
    ...
    $.ajax({
      url: `http://192.168.29.243:4000/getcatsection/${categoryId}`, // Replace 'your-api-endpoint' with the actual endpoint URL for fetching subcategories based on the category ID
      method: 'GET',
     success: function (response) {
      const sections = response.data; // Assuming the response data is an array of section objects
      // Update the state with the fetched section data
  ...
  $.ajax({
    url: 'http://192.168.29.243:4000/additemmaster',
    method: 'POST',
...
export default AddNewIMComponent;
