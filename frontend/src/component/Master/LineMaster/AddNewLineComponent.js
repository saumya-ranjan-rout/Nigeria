...
export function AddNewLineComponent() {
  ...
  const handleSubmit = (event) => {
    ...
    $.ajax({
      url: 'http://192.168.29.243:4000/addline',
      method: 'POST',
      data: formData,
              ...
              <label className="col-sm-2 col-form-label"
                    ...
                    <div className="col-sm-6">
                        <input type="text" placeholder=" Name"
                               className="form-control margin-bottom  required" name="line_name" id="line_name" value={formData.line_name}  onChange={handleInputChange} required/>
                    </div>
                </div>
...
export default AddNewLineComponent;
