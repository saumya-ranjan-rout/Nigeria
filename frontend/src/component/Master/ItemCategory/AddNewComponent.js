...
export function AddNewComponent() {
  ...
  const handleSubmit = (event) => {
    ...
    $.ajax({
      url: 'http://192.168.29.243:4000/additemcategory',
      method: "POST",
      data: formData,
      success: function (response) {
        //console.log(response);
        // Redirect to ItemCategoryComponent after successful addition
      //history.push('/master/item-category');
    ...
    //alert("Added Item Category Successfully..");
  };
              ...
              <div className="form-group row">
                  ...
                  <div className="col-sm-6">
                      <input type="text" placeholder=" Name"
                            className="form-control margin-bottom  required" name="category_name"  value={formData.category_name} onChange={handleInputChange}  required />
                  </div>
              </div>
