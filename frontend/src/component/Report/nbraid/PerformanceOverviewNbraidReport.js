...
export function PerformanceOverviewNbraidReport() {
  ...
  const handleSubmit = (event) => {
    ...
    $.ajax({
      url: "http://192.168.29.243:4000/Nbraid/get_performance_overview_search_data",
      method: "POST",
      data: jsonData,
      processData: false,
...
useEffect(() => {
  ...
  if (!isLoggedIn) {
    ...
    $.ajax({
      url: "http://192.168.29.243:4000/Nbraid/get_performance_overview_data",
      method: "GET",
      processData: false,
      contentType: "application/json",
      success: function (response) {
