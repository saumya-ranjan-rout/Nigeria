...
export function WastagePerItemReport() {
  ...
  const handleSubmit = (event) => {
    ...
    $.ajax({
      url: "http://192.168.29.243:4000/braid/get_wastage_item_search_data",
      method: "POST",
      data: jsonData,
      processData: false,
  ...
  useEffect(() => {
    ...
    if (!isLoggedIn) {
      ...
      setLoading(true);
      $.ajax({
        url: 'http://192.168.29.243:4000/get_wastage_item_data',
        method: 'GET',
        processData: false,
        contentType: 'application/json',
        success: function (response) {
      ...
      <section id="content">
        ...
        <main>
          <div className="container dt">
            <h5 className="title">Wastage Per Item</h5>
            <br />
