...
export function MachineEffPpmReport() {
  ...
  const handleSubmit = (event) => {
    ...
    $.ajax({
      url: "http://192.168.29.243:4000/braid/get_machineEffppm_search_data",
      method: "POST",
      data: jsonData,
      processData: false,
...
useEffect(() => {
  document.title = "Machine Efficiency PPM";
  ...
  if (!isLoggedIn) {
    ...
    $.ajax({
      url: "http://192.168.29.243:4000/braid/get_machineEffPpm_data",
      method: "GET",
      processData: false,
      contentType: "application/json",
      success: function (response) {
...
export default MachineEffPpmReport;
