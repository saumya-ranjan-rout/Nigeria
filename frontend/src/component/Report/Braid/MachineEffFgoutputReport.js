...
export function MachineEffFgoutputReport() {
  ...
  const handleSubmit = (event) => {
    ...
    $.ajax({
      url: "http://192.168.29.243:4000/braid/get_machineEffFgoutput_search_data",
      method: "POST",
      data: jsonData,
      processData: false,
...
useEffect(() => {
  ...
  document.title = "Machine Efficiency FG Output";
  ...
  if (!isLoggedIn) {
    ...
    $.ajax({
      url: "http://192.168.29.243:4000/braid/get_machineEffFgoutput_data",
      method: "GET",
      processData: false,
      contentType: "application/json",
      success: function (response) {
...
export default MachineEffFgoutputReport;
