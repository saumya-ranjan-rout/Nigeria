...
const [startDate, setStartDate] = useState(oneMonthAgo);
   ...
   const handleSubmit = (event) => {
    ...
    $.ajax({
      url: 'http://192.168.29.243:4000/getsearchproductionbreakdown',
      method: "POST",
      data: jsonData,
      processData: false,
...
*/
                           ...
                           
                             {
                                ...
                                data: 'item', // Specify the data source for this column
                                 ...
                                 render: function (data, type, row, meta) {
                                  ...
                                  $.ajax({
                                    url: 'http://192.168.29.243:4000/get-item-description', // Replace with your API endpoint
                                    method: 'GET',
                                    data: {
                                      id: id,
                                ...
                                title: 'FG OUTPUT',
                                 render: function (data, type, row, meta) {
                                  ...
                                  let tfg = ''; // Initialize with an empty string
                                    ...
                                    $.ajax({
                                      url: 'http://192.168.29.243:4000/get-fg-output',
                                      method: 'GET',
                                     data: {
                                ...
                                title: 'Direct Worker',
                                 render: function (data, type, row, meta) {
                                  ...
                                  let tw = ''; // Initialize with an empty string
                                    ...
                                    $.ajax({
                                      url: 'http://192.168.29.243:4000/get-direct-worker',
                                      method: 'GET',
                                     data: {
                                        id: itemValue,    // Send 'item' as 'id'
                                        wh: whValue,      // Send 'wh' as 'wh'
   ...
   $.ajax({
        url: 'http://192.168.29.243:4000/getdefaultproductionbreakdown',
        method: 'GET',
        processData: false,
        contentType: 'application/json',
       success: function (response) {
        ...
        <section id="content">
          ...
          <main>
            <div className="container dt">
              <h5 className="title">Production Breakdown</h5>
              <br/>
