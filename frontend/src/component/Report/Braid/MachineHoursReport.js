...
export function MachineHoursReport() {
  ...
  const handleSubmit = (event) => {
    ...
    $.ajax({
      url: "http://192.168.29.243:4000/braid/get_machineHour_search_data",
      method: "POST",
      data: jsonData,
      processData: false,
...
useEffect(() => {
  ...
  if (!isLoggedIn) {
    ...
    $.ajax({
      url: "http://192.168.29.243:4000/braid/get_machineHour_data",
      method: "GET",
      processData: false,
      contentType: "application/json",
      success: function (response) {
...
export default MachineHoursReport;
