...
export function FgOutputComponentNbraid() {
...
const handleEdit = (id) => {
 ...
 const handleSubmit = (event) => {
    ...
    const dateValue = adjustedDate.toISOString().split('T')[0];
      ...
      $.ajax({
        url: 'http://192.168.29.243:4000/get_fg_output_search_ikeja_nbraid',
        method: 'POST',
        data: { date: dateValue },
...
const handleDelete = (id) => {
    ...
    $.ajax({
      url: 'http://192.168.29.243:4000/get_fg_output_default_ikeja_nbraid',
      method: 'GET',
      processData: false,
      ...
      <section id="content">
        ...
        <main>
          <div className="container dt">
            ...
            <Link to="/fgoutput/add_fgoutput_ikeja_nbraid" className="btn btn-success btn-sm rounded">
              Add new
            </Link>
            </h5><br></br>
            <h5>Date Range</h5>
...
export default FgOutputComponentNbraid;
