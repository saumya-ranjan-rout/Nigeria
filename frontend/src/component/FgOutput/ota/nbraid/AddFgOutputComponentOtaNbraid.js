...
export function AddFgOutputComponentOtaNbraid() {
...
/*  const handleSubmit = (event) => {
  ...
  $.ajax({
    url: 'http://192.168.29.243:4000/addfgoutputotanbraid',
    method: 'POST',
    data: jsonData,
    processData: false,
...
const handleSubmit = (event) => {
  ...
  $.ajax({
    url: `http://192.168.29.243:4000/addfgoutputotanbraid?userid=${userid}`,
    method: 'POST',
    data: jsonData,
    processData: false,
    contentType: 'application/json',
...
{roleId == 5 && (
                ...
                <div className="col-sm-2">
                  ...
                  <Select
                    options={lineOptions.map(option => ({ value: option.line_name, label: option.line_name }))}
             ...
             <div class="col-sm-3 ">
                     ...
                     <span className="textgreen">Fg Output <span className="textred">*</span></span> 
                         <input  type="text" className="form-control margin-bottom  " name="fgoutput" placeholder="" value={formData.fgoutput} required onChange={handleInputChange}/>
...
export default AddFgOutputComponentOtaNbraid;
