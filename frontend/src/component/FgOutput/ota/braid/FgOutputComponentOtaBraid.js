...
export function FgOutputComponentOtaBraid() {
...
const handleEdit = (id) => {
 ...
 const handleSubmit = (event) => {
    ...
    const dateValue = adjustedDate.toISOString().split('T')[0];
      ...
      $.ajax({
        url: 'http://192.168.29.243:4000/get_fg_output_search_ota',
        method: 'POST',
        data: { date: dateValue },
...
const handleDelete = (id) => {
    ...
    $.ajax({
      url: 'http://192.168.29.243:4000/get_fg_output_default_ota',
      method: 'GET',
      processData: false,
...
export default FgOutputComponentOtaBraid;
