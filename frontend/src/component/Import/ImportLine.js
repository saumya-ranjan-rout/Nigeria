...
export function ImportLine() {
  ...
  $.ajax({
      url: 'http://192.168.29.243:4000/uploadline',
      method: 'POST',
      data: formData,
      contentType: false,
      processData: false,
 ...
 /* const baseUrl = 'http://192.168.29.243:3000'; // Replace with your base URL
  const templatePath = '/importfiles/Line-Master.csv';
  const templateURL = baseUrl + templatePath;*/

  const templateURL = process.env.PUBLIC_URL + '/importfiles/Line-Master.csv';
  ...
  return (
    ...
    <Sidebar />
      ...
      <Header />
        ...
        <h5 className="title">Import Lines{' '}
         ...
         <hr></hr>
             ...
             <div className="centered-container">
                ...
                <p>
                  ...
                  *Your line data file should as per this template{' '}</span>
              ...
              <div className="form-group row">
                  ...
                  <div className="col-sm-4">
                      <input type="submit" id="submit-data" className="btn btn-success margin-top"
                            value="Import Lines" data-loading-text="Adding..." />
