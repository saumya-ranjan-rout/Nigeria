...
export function ImportNbraidUpdateAttendance() {
...
const handleBackup = (event) => {
    ...
    $.ajax({
      url: 'http://192.168.29.243:4000/downloademployeebackupNbraid',
      method: 'GET',
      xhrFields: {
  ...
  $.ajax({
      url: 'http://192.168.29.243:4000/updateattendancenbraid',
      method: 'POST',
      data: formData,
      contentType: false,
      processData: false,
  ...
  return (
    ...
    <Sidebar />
      ...
      <Header />
        ...
        <h5 className="title">Update Employee Attendance For OTA{' '}
...
export default ImportNbraidUpdateAttendance;
