...
export function ImportOperator() {
 ...
 const [importStatus, setImportStatus] = useState('');
  ...
  useEffect(() => {
    document.title = 'Import Operator';
  ...
  $.ajax({
      url: 'http://192.168.29.243:4000/uploadoperator',
      method: 'POST',
      data: formData,
      contentType: false,
      processData: false,
  ...
  const templatePath = '/importfiles/operator_import.csv';
  ...
  return (
    ...
    <Sidebar />
      ...
      <Header />
        ...
        <h5 className="title">Import Operator{' '}
        ...
        <form onSubmit={handleSubmit} method='POST' encType="multipart/form-data">
         <hr></hr>
             ...
             <div className="centered-container">
                <p>
                  Your employee data file should be as per this template{' '}
              ...
              <div className="form-group row">
                  ...
                  <div className="col-sm-4">
                      <input type="submit" id="submit-data" className="btn btn-success margin-top"
                            value="Import Operator" data-loading-text="Adding..." />
