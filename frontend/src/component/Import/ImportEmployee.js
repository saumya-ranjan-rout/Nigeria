...
export function ImportEmployee() {
...
const handleBackup = (event) => {
  ...
  $.ajax({
      url: 'http://192.168.29.243:4000/uploademployee',
      method: 'POST',
      data: formData,
      contentType: false,
      processData: false,
  ...
  return (
    ...
    <Sidebar />
      ...
      <Header />
        ...
        <h5 className="title">Import Employee{' '}
             ...
             <div className="centered-container">
                 <form onSubmit={handleBackup}>
                  ...
                  <p>
                    ...
                    *Before Importing Employee Master Please Take a Backup{' '} </span>
                ...
                <p>
                 <span style={{ color: 'red' }}>
                  *Your employee data file should be as per this template{' '}</span>
