...
export function ImportItemColorCode() {
  ...
  useEffect(() => {
    document.title = 'Import Item Code';
  ...
  $.ajax({
      url: 'http://192.168.29.243:4000/uploaditemcolorcode',
      method: 'POST',
      data: formData,
      contentType: false,
      processData: false,
  ...
  const templatePath = '/importfiles/Item-Code.csv';
  const templateURL = baseUrl + templatePath;*/

   const templateURL = process.env.PUBLIC_URL + '/importfiles/Item-Code.csv';
  ...
  return (
    ...
    <Sidebar />
      ...
      <Header />
        ...
        <h5 className="title">Import Item Code{' '}
         ...
         <hr></hr>
             ...
             <div className="centered-container">
                ...
                <p>
                  ...
                  *Your item description data file should as per this template{' '}</span>
...
export default ImportItemColorCode;
