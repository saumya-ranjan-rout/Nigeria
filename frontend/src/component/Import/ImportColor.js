...
export function ImportColor() {
  ...
  $.ajax({
      url: 'http://192.168.29.243:4000/uploadcolor',
      method: 'POST',
      data: formData,
      contentType: false,
      processData: false,
  ...
  const templateURL = process.env.PUBLIC_URL + '/importfiles/Color-Master.csv';
  ...
  return (
    ...
    <Sidebar />
      ...
      <Header />
        ...
        <h5 className="title">Import Colors{' '}
         ...
         <hr></hr>
             ...
             <div className="centered-container">
                ...
                <p>
                  ...
                  *Your color data file should as per this template{' '}</span>
              ...
              <div className="form-group row">
                  ...
                  <div className="col-sm-4">
                      <input type="submit" id="submit-data" className="btn btn-success margin-top"
                            value="Import Colors" data-loading-text="Adding..." />
