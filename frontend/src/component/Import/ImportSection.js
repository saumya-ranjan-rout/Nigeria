...
export function ImportSection() {
  ...
  useEffect(() => {
    document.title = 'Import Sections';
  ...
  $.ajax({
      url: 'http://192.168.29.243:4000/uploadsection',
      method: 'POST',
      data: formData,
      contentType: false,
      processData: false,
  ...
  const templatePath = '/importfiles/Section-Master.csv';
  const templateURL = baseUrl + templatePath;*/

   const templateURL = process.env.PUBLIC_URL + '/importfiles/Section-Master.csv';
  ...
  return (
    ...
    <Sidebar />
      ...
      <Header />
        ...
        <h5 className="title">Import Sections{' '}
         ...
         <hr></hr>
             ...
             <div className="centered-container">
                ...
                <p>
                  ...
                  *Your section data file should as per this template{' '}</span>
              ...
              <div className="form-group row">
                  ...
                  <div className="col-sm-4">
                      <input type="submit" id="submit-data" className="btn btn-success margin-top"
                            value="Import Sections" data-loading-text="Adding..." />
