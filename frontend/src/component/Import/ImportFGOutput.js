...
export function ImportFGOutput() {
  ...
  useEffect(() => {
    document.title = 'Import FG Details';
  ...
  $.ajax({
      url: 'http://192.168.29.243:4000/uploadfgdetails',
      method: 'POST',
      data: formData,
      contentType: false,
      processData: false,
  ...
  const templatePath = '/importfiles/FgOutput.csv';
  const templateURL = baseUrl + templatePath;*/

   const templateURL = process.env.PUBLIC_URL + '/importfiles/FgOutput.csv';
  ...
  return (
    ...
    <Sidebar />
      ...
      <Header />
        ...
        <h5 className="title">Import FG Details{' '}
         ...
         <hr></hr>
             ...
             <div className="centered-container">
                ...
                <p>
                  ...
                  *Your fgoutput data file should as per this template{' '}</span>
              ...
              <div className="form-group row">
                  ...
                  <div className="col-sm-4">
                      <input type="submit" id="submit-data" className="btn btn-success margin-top"
                            value="Import FG Details" data-loading-text="Adding..." />
