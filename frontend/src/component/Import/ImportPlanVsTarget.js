...
export function ImportPlanVsTarget() {
  ...
  useEffect(() => {
    document.title = 'Import Plan Vs Target';
  ...
  $.ajax({
      url: 'http://192.168.29.243:4000/uploadplanvstarget',
      method: 'POST',
      data: formData,
      contentType: false,
      processData: false,
  ...
  const templatePath = '/importfiles/Target.csv';
  const templateURL = baseUrl + templatePath;*/

  const templateURL = process.env.PUBLIC_URL + '/importfiles/Target.csv';
  ...
  return (
    ...
    <Sidebar />
      ...
      <Header />
        ...
        <h5 className="title">Import Plan Vs Target{' '}
         ...
         <hr></hr>
             ...
             <div className="centered-container">
                ...
                <p>
                  ...
                  *Your Plan Vs Target data file should as per this template{' '}</span>
...
export default ImportPlanVsTarget;
