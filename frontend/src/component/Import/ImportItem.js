...
export function ImportItem() {
  ...
  useEffect(() => {
    document.title = 'Import Item Master';
  ...
  $.ajax({
      url: 'http://192.168.29.243:4000/uploaditem',
      method: 'POST',
      data: formData,
      contentType: false,
      processData: false,
  ...
  const templatePath = '/importfiles/Item-Master.csv';
  ...
  return (
    ...
    <Sidebar />
      ...
      <Header />
        ...
        <h5 className="title">Import Items{' '}
         ...
         <hr></hr>
             ...
             <div className="centered-container">
                ...
                <p>
                  ...
                  *Your item data file should as per this template{' '}</span>
              ...
              <div className="form-group row">
                  ...
                  <div className="col-sm-4">
                      <input type="submit" id="submit-data" className="btn btn-success margin-top"
                            value="Import Items" data-loading-text="Adding..." />
