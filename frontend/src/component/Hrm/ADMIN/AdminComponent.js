...
export function AdminComponent() {
  ...
  const handleView = (id) => {
    history.push(`/hrm/view_admin/${id}`);
  };
    ...
    if (confirmDelete) {
      $.ajax({
        url: `http://192.168.29.243:4000/admin_delete/${id}`,
        method: 'DELETE',
  ...
  const fetchData = () => {
    $.ajax({
      url: 'http://192.168.29.243:4000/admin',
      method: 'GET',
      success: function (response) {
          ...
          columnDefs: [
            ...
            },
            {
              ...
              render: function (data, type, row, meta) {
                ...
                return `
                 <button class="btn btn-sm btn-info" onclick="handleView(${id})" title="View"><i class="bx bx-show-alt"></i> </button>
                  
                  <button class="btn btn-sm btn-danger" onclick="handleDelete(${id})" title="Delete"><i class="bx bxs-trash"></i></button>
                `;
              },
            },
          ],
  ...
  return (
    ...
    <Sidebar />
      ...
      <Header />
        ...
        <h5 className="title">Admin{' '}
            <Link to="/hrm/admin_add/" className="btn btn-success btn-sm rounded">
              Add new
            </Link>
            </h5>
        </div>
