...
export function MultipleChangeZone() {
 ...
 const handleSubmit = (event) => {
  ...
  if (isValid) {
  $.ajax({
    url: 'http://192.168.29.243:4000/ota/update_multiple_zone',
    method: "POST",
    data: jsonData,
    processData: false,
         ...
         <form  onSubmit={handleSubmit} method='POST'>
            <div className="row space ">
               ...
               <div className="col-sm-6">
                <span className="Zone">Zone<span style={red}>*</span></span>
              ...
              <div className='col-sm-6'>
                <span className="Machine">Machine<span style={red}>*</span></span>
