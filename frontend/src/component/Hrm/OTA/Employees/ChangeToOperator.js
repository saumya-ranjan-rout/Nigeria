...
const [formData, setFormData] = useState({
  ...
  $.ajax({
    url: 'http://192.168.29.243:4000/ota/changeEmpToOp',
    method: 'POST',
    data: jsonData,
    processData: false,
                ...
                <div className='col-md-12'>
                    ...
                    <div className="row space">
                        <div className="col-sm-6">
                          ...
                          <input type="hidden" className="form-control" name="staff" value={formData.staff} onChange={handleInputChange} />
                        </div>
                       ...
                       <div className=" row space">
                            ...
                            <button type="button" className='btn btn-warning btn-md' onClick={cancel}>Cancel</button>
                            </div>
                        </div>
                </form>
                </div>
