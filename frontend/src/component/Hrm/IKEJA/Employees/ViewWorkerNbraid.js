...
export function ViewWorkerNbraid() {
  const {id} = useParams();
          ...
          <div className="container dt">
            ...
            <hr></hr>
             ...
             <div className='row'>
                ...
                {worker.roleid == '1' ? (
                  <>
                    <Link to={`/hrm/ikeja/editemployeesnbraid/${id}`}>
                  ...
                  <>
                    <Link to={`/hrm/ikeja/editoperator/${id}`}>
                      <button className='btn btn-info' style={{ color: '#fff' }}>
                        <i className="bx bx-user"></i>
                        Edit Account
                      </button>
                   ...
                   <Link to={`/hrm/ikeja/changepassword/${worker.entryid}`}>
                     <button className="btn btn-info" style={{color:'#fff'}}>
                       <i class="bx bx-pen"></i> 
                       Change Password
                     </button>
...
export default ViewWorkerNbraid;
