...
export function ConvertToCategory() {
  ...
  fetchshift();
   ...
   const fetchOperator = () => {
    $.ajax({
      url: `http://192.168.29.243:4000/ikeja/getConvertdata/${id}`,
      method: 'GET',
      success: function (response) {
 ...
 let typ;
  ...
  $.ajax({
    url: 'http://192.168.29.243:4000/ikeja/category_convert_op',
    method: 'POST',
    data: jsonData,
    processData: false,
          ...
          <form onSubmit={handleSubmit} method='POST' >
              ...
              <div className="col-sm-6">
                ...
                {formData.category_type === "BRAID" ? (
                  <div style={{display:'inline-flex'}}>
                    ...
                    />
                    <label style={{fontSize:'20px',margin:'0px'}}><span className='textblack'>{typ}</span></label>
                  </div>
                    ) : (
                    <div style={{display:'inline-flex'}}>
                        <input
             ...
             <div className=" row space">
                <div className="col-sm-6">
                   ...
                   <Link to="/hrm/ikeja/operator" className="btn btn-info btn-md">Cancel</Link>
                </div>
             </div>
          </form>
       </div>
