...
export function ChangeShiftComponent() {
  ...
  const handleSubmit = (event) => {
    ...
    $.ajax({
      ...
      success: function (response) {
        ...
        const { timesheet, site, shift, product_name, section } = response;
  ...
  const handleMove = (entryIds) => {
    ...
    history.push(`/hrm/multiplechangeshift?${queryParams}`);
  };
        ...
        <section id="content">
          ...
          <main>
            <div className="container dt">
              <h5 className="title">Change Shift[Filter]</h5>
              <hr></hr>
...
export default ChangeShiftComponent;
